...
<html lang="en" xmlns="http://www.w3.org/1999/html">
 ...
 <body>
	<div id="title_container"><h1>The Interactive Narrator</h1></div>
	...
	<div id="showcase_container">
		...
		<div class="showcase_item">
			<a href="http://eve-digital.nl/interactive-narrator/vis.php?file=WebCompany-2889e#" title="WebCompany" target="_blank">
				<img src="img/webcompany.jpg">
			</a>
			<h3 style="position:absolute;">WebCompany</h3>
		</div>
		<div class="showcase_item">
			<a href="http://eve-digital.nl/interactive-narrator/vis.php?file=CMScompany-6de43" title="CMScompany" target="_blank">
